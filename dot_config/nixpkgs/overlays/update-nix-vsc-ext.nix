self: super: {
    # This script is found here. I made it into a script bin so I dont have to store the script somewhere
    # https://github.com/NixOS/nixpkgs/blob/master/pkgs/misc/vscode-extensions/update_installed_exts.sh
    update-nix-vsc-ext = super.writeShellApplication {
        name = "update-nix-vsc-ext";
        runtimeInputs = [super.curl super.jq super.unzip];
        text = ''
